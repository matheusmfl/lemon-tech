...
export function Hero() {
  return (
    <section className="relative px-6 flex flex-col py-5 gap-10">
      <div
        className="absolute left-0 top-1/2 h-[271px] w-[208px] -translate-y-48 rounded-full -translate-x-1/2
     opacity-50 blur-full bg-gradient-image"
      ...
      <div className="pt-14 z-10">
        <h1 className="font-semibold text-4xl leading-[48px] text-slate-50 text-left">
          Design e<br /> Tecnologia para vendas e gestão administrativa
        </h1>
      </div>
      ...
      <button className="font-medium leading-5 hover:brightness-95 text-slate-50 py-[10px] w-full text-center bg-teal-700 rounded-[4px]">
        Comece agora
      </button>
